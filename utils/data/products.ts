export const products = [
  ...
  {
    name: 'Drawer Side',
    mainPicture: '/assets/images/drawer_side_1_-removebg-preview.png',
    pictures: [
      '/assets/images/drawer_side_1_-removebg-preview.png',
      '/assets/images/drawerside2.jpeg',
    ],
    description:
      'Our selection of exterior wood doors are made from premium grade wood species including white oak, black walnut and glass',
  },
  ...
  {
    name: 'Wood Floor',
    mainPicture: '/assets/images/image3-removebg.png',
